...
<p align="center">
  ...
  <a href="https://github.com/iand675/hs-opentelemetry/releases">
    <img alt="GitHub release (latest by date including pre-releases)" src="https://img.shields.io/github/v/release/iand675/hs-opentelemetry?include_prereleases&style=for-the-badge">
  </a>
...
|-----------|--------------------------|------------------------------|--------------------|
| OTLP      | otel-exporter-otlp       | OpenTelemetry.Exporter.OTLP  | :white_check_mark: |
