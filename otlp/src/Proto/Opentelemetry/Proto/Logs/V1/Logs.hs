...
data InstrumentationLibraryLogs
  = InstrumentationLibraryLogs'_constructor {_InstrumentationLibraryLogs'instrumentationLibrary :: !(Prelude.Maybe Proto.Opentelemetry.Proto.Common.V1.Common.InstrumentationLibrary),
...
instance Data.ProtoLens.Field.HasField LogRecord "name" Data.Text.Text where
  fieldOf _
    = (Prelude..)
        (Lens.Family2.Unchecked.lens
           _LogRecord'name (\ x__ y__ -> x__ {_LogRecord'name = y__}))
        Prelude.id
  ...
  parseMessage
    = let
        ...
        loop x mutable'instrumentationLibraryLogs
          = do end <- Data.ProtoLens.Encoding.Bytes.atEnd
               if end then
                   do frozen'instrumentationLibraryLogs <- Data.ProtoLens.Encoding.Parser.Unsafe.unsafeLiftIO
                                                             (Data.ProtoLens.Encoding.Growing.unsafeFreeze
                      ...
                      Prelude.return
                        (Lens.Family2.over
                           ...
                           (Lens.Family2.set
                              ...
                              frozen'instrumentationLibraryLogs x))
               else
                   do tag <- Data.ProtoLens.Encoding.Bytes.getVarInt
                      case tag of
                        10
                        ...
                        18
                          -> do !y <- (Data.ProtoLens.Encoding.Bytes.<?>)
                                ...
                                v <- Data.ProtoLens.Encoding.Parser.Unsafe.unsafeLiftIO
                                       (Data.ProtoLens.Encoding.Growing.append
                                          mutable'instrumentationLibraryLogs y)
                                loop x v
                        26
                          -> do y <- (Data.ProtoLens.Encoding.Bytes.<?>)
                                       (do value <- do len <- Data.ProtoLens.Encoding.Bytes.getVarInt
      ...
      in
        (Data.ProtoLens.Encoding.Bytes.<?>)
          (do mutable'instrumentationLibraryLogs <- Data.ProtoLens.Encoding.Parser.Unsafe.unsafeLiftIO
                                                      Data.ProtoLens.Encoding.Growing.new
                   ...
                   (\ _v
                      -> (Data.Monoid.<>)
                           ...
                           ((Prelude..)
                              ...
                              Data.ProtoLens.encodeMessage _v))
                   (Lens.Family2.view
                      (Data.ProtoLens.Field.field @"vec'instrumentationLibraryLogs") _x))
                ((Data.Monoid.<>)
                   (let
                      _v = Lens.Family2.view (Data.ProtoLens.Field.field @"schemaUrl") _x
                    in
