...
data MetricConfigRequest
  = MetricConfigRequest'_constructor {_MetricConfigRequest'resource :: !(Prelude.Maybe Proto.Opentelemetry.Proto.Resource.V1.Resource.Resource),
    ...
    = let
                      ...
                      case tag of
                        ...
                        18
                          -> do y <- (Data.ProtoLens.Encoding.Bytes.<?>)
                                ...
                                loop
                                  (Lens.Family2.set
                                     (Data.ProtoLens.Field.field @"lastKnownFingerprint") y x)
                        wire
      ...
      in
        (Data.ProtoLens.Encoding.Bytes.<?>)
          (do loop Data.ProtoLens.defMessage) "MetricConfigRequest"
  buildMessage
    = \ _x
        -> (Data.Monoid.<>)
             (case
             ...
             ((Data.Monoid.<>)
                (let
                   _v
                     = Lens.Family2.view
                         (Data.ProtoLens.Field.field @"lastKnownFingerprint") _x
                 in
...
data MetricConfigResponse
  = MetricConfigResponse'_constructor {_MetricConfigResponse'fingerprint :: !Data.ByteString.ByteString,
                      ...
                      case tag of
                        ...
                        24
                          -> do y <- (Data.ProtoLens.Encoding.Bytes.<?>)
                                ...
                                loop
                                  (Lens.Family2.set
                                     (Data.ProtoLens.Field.field @"suggestedWaitTimeSec") y x)
                                  mutable'schedules
                        wire
                          -> do !y <- Data.ProtoLens.Encoding.Wire.parseTaggedValueFromWire
                                        wire
             ...
             ((Data.Monoid.<>)
                ...
                ((Data.Monoid.<>)
                   (let
                      _v
                        = Lens.Family2.view
                            (Data.ProtoLens.Field.field @"suggestedWaitTimeSec") _x
                    in
                      if (Prelude.==) _v Data.ProtoLens.fieldDefault then
                          Data.Monoid.mempty
                      else
...
data MetricConfigResponse'Schedule
  = MetricConfigResponse'Schedule'_constructor {_MetricConfigResponse'Schedule'exclusionPatterns :: !(Data.Vector.Vector MetricConfigResponse'Schedule'Pattern),
  ...
  parseMessage
    = let
        ...
        loop x mutable'exclusionPatterns mutable'inclusionPatterns
          = do end <- Data.ProtoLens.Encoding.Bytes.atEnd
               if end then
                   do frozen'exclusionPatterns <- Data.ProtoLens.Encoding.Parser.Unsafe.unsafeLiftIO
                                                    (Data.ProtoLens.Encoding.Growing.unsafeFreeze
                                                       mutable'exclusionPatterns)
                      frozen'inclusionPatterns <- Data.ProtoLens.Encoding.Parser.Unsafe.unsafeLiftIO
                                                    (Data.ProtoLens.Encoding.Growing.unsafeFreeze
                        ...
                        24
                          -> do y <- (Data.ProtoLens.Encoding.Bytes.<?>)
                                ...
                                loop
                                  ...
                                  mutable'exclusionPatterns mutable'inclusionPatterns
                        wire
                          -> do !y <- Data.ProtoLens.Encoding.Wire.parseTaggedValueFromWire
                                        wire
                                loop
      ...
      in
        (Data.ProtoLens.Encoding.Bytes.<?>)
          (do mutable'exclusionPatterns <- Data.ProtoLens.Encoding.Parser.Unsafe.unsafeLiftIO
                                             Data.ProtoLens.Encoding.Growing.new
              mutable'inclusionPatterns <- Data.ProtoLens.Encoding.Parser.Unsafe.unsafeLiftIO
                                             Data.ProtoLens.Encoding.Growing.new
              loop
                Data.ProtoLens.defMessage mutable'exclusionPatterns
                mutable'inclusionPatterns)
          "Schedule"
  buildMessage
    = \ _x
                ...
                (\ _v
                   -> (Data.Monoid.<>)
                        ...
                        ((Prelude..)
                           ...
                           Data.ProtoLens.encodeMessage _v))
                (Lens.Family2.view
                   (Data.ProtoLens.Field.field @"vec'exclusionPatterns") _x))
             ((Data.Monoid.<>)
                (Data.ProtoLens.Encoding.Bytes.foldMapBuilder
                   (\ _v
                      -> (Data.Monoid.<>)
                           ...
                           ((Prelude..)
                              ...
                              Data.ProtoLens.encodeMessage _v))
                   (Lens.Family2.view
                      (Data.ProtoLens.Field.field @"vec'inclusionPatterns") _x))
                ((Data.Monoid.<>)
                   (let
...
data MetricConfigResponse'Schedule'Pattern
  = MetricConfigResponse'Schedule'Pattern'_constructor {_MetricConfigResponse'Schedule'Pattern'match :: !(Prelude.Maybe MetricConfigResponse'Schedule'Pattern'Match),
  ...
  fieldOf _
    = (Prelude..)
        ...
        (Lens.Family2.Unchecked.lens
           ...
           (\ _ y__
              -> Prelude.fmap
                   MetricConfigResponse'Schedule'Pattern'StartsWith y__))
...
instance Data.ProtoLens.Message MetricConfigResponse'Schedule'Pattern where
  ...
  parseMessage
    = let
      ...
      in
        (Data.ProtoLens.Encoding.Bytes.<?>)
          (do loop Data.ProtoLens.defMessage) "Pattern"
  buildMessage
    = \ _x
        -> (Data.Monoid.<>)
             (case
